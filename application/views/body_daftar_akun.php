<div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Daftar Akun</h4>                
            </div>
        </div>         
             <div class="row">
              <div class="col-md-4 col-sm-4 col-xs-12" >
                        <div class="alert alert-info text-center">
                          ...
                          <p>
                         Isilah data dengan benar. Jika memiliki kesulitan saat pengisian formulir anda bisa menghubungi kami.
                        </p>
                        <hr />
                           <a href="https://auto2000.co.id/" class="btn btn-info">Hubungi Kami</a> 
                        </div>
                 </div>
              <div class="col-md-8 col-sm-8 col-xs-12">
               <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="<?php echo base_url().'cont_user/daftar/2'?>">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary" style="padding-left: 40px;padding-right: 40px;" name="daftar" >Sign In</button>
                                        </div>
                                  </form>
                            </div>
                        </div>
