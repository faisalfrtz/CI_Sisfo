              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
               <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="<?php echo base_url().'cont_changepass/sendMail'?>">
                                 ...
                                 <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success" style="padding-left: 40px;padding-right: 40px;" name="change" >Send New Password</button>
                                        </div>
                                  </form>
                            </div>
                        </div>
