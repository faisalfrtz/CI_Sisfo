...
<div class='box-body'>
      ...
      <tbody>
        ...
        <td style="text-align:center" width="200px">
                            ...
                            <a href="<?=base_url('file/delete/'.$file->file_id)?>">
                              <i class="fa fa-trash-o" onclick="return confirm('Apakah anda yakin ingin menghapus?')" style="font-size:24px;color:#716969"></i>
                            </a>
                          </td>
          </tr>
                <?php
